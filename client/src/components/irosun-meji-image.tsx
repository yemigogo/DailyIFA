...
interface IrosunMejiImageProps {
  className?: string;
  size?: 'small' | 'medium' | 'large';
  showCaption?: boolean;
}

const IrosunMejiImage: React.FC<IrosunMejiImageProps> = ({ 
  className = '', 
  size = 'medium', 
  showCaption = false 
}) => {
...
export default IrosunMejiImage;