...
const Learning: React.FC = () => {
  ...
  const learningModules: LearningModule[] = [
    ...
    {
      id: "cosmic-realms-3d",
      title: "3D Cosmic Realms",
      titleYoruba: "Àwọn Àgbáyé 3D",
      description: "Interactive 3D visualization of Òrun, Ayé, and Ilẹ̀-Ọkùn with floating Orisha spheres",
    ...
    {
      id: "esu-transformation",
      title: "Èṣù Transformation Healing",
      titleYoruba: "Ìwòsàn Ìyípadà Èṣù",
      description: "Guardian of crossroads - fire frequencies for transformation, path opening, and breaking limitations",
